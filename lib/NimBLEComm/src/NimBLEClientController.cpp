...
void NimBLEClientController::sendScaleCalibration(float, float, long, long) {}
void NimBLEClientController::startScaleCalibration(uint8_t, float) {}
void NimBLEClientController::registerScaleOffsetsCallback(const scale_offsets_callback_t &) {}
void NimBLEClientController::registerScaleCalResultCallback(const scale_cal_result_callback_t &) {}
