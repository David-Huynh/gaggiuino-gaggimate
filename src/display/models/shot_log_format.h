...
// Reserved missing-value sentinel for recovered artifacts without cumulative telemetry.
static constexpr uint16_t SHOT_LOG_WATER_PUMPED_UNKNOWN = UINT16_MAX;
