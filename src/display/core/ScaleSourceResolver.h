...
struct ScaleAvailability {
    bool bluetoothConnected = false; // BLE scale is connected and recently publishing
...
// the caller turns into a timed brew). AUTO prefers Bluetooth, then hardware,
// then predictive.
