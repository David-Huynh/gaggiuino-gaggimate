      ...
      <div className='mb-4 flex items-start justify-between gap-3'>
        <div>
          ...
          <p className='text-base-content/60 mt-1 text-sm'>
            HX711 two-position tray calibration. Tare empty, then capture a known weight on
            each side of the tray; each capture records both channels to compensate tray
            cross-coupling.
          </p>
        </div>
        <HealthBadge
      ...
      <div className='grid grid-cols-1 gap-4 lg:grid-cols-12'>
        ...
        <Card sm={12} lg={6} title='Tare and calibrate'>
          <div className='space-y-6'>
            ...
            <div className='divider'>Step 2 - capture both tray sides</div>
            ...
            {[1, 2].map(ch => {
              ...
              return (
                <div key={ch}>
                  <p className='text-base-content/60 mb-3 text-sm'>
                    Place a known weight on the <strong>channel {ch} side</strong>, enter its
                    mass, then press calibrate. Calibrate both sides after the same tare before
                    trusting total weight.
                  </p>
