  ...
  useEffect(() => {
    ...
    const listenerId = apiService.on('evt:rl:status', message => {
      setFormData(current => ({
        ...
        rlLastShotType: message.rlLastShotType,
        rlLastShotTimeS: message.rlLastShotTimeS,
        rlLastShotBeverageOutG: message.rlLastShotBeverageOutG,
        rlLastShotTargetYieldG: message.rlLastShotTargetYieldG,
        rlLastShotHumanRating: message.rlLastShotHumanRating,
